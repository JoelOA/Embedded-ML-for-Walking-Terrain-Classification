...
void setup() {
  ...
  resolver.AddConv2D();       // Conv2D to handle Conv1D by reshaping
  resolver.AddFullyConnected(); 
  resolver.AddSoftmax();      // Add softmax layer if present
  resolver.AddReshape();      // Reshape to adjust dimensions
